...
export default function TaskManagement() {
  const pageTitle = 'Task Management Application | Dulaj Personal';
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-3xl p-8">
                <div className="mb-6">
                  ...
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Task Management Application</h1>
                </div>
