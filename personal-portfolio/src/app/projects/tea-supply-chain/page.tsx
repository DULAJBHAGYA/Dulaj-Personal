          ...
          >
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-3xl p-8">
                <div className="mb-6">
                  <span className="text-base font-semibold text-gray-500 dark:text-gray-400">Blockchain Project</span>
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">LeafLink - Tea Supply Chain Solution</h1>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Hybrid Consensus Mechanism</h3>
                    <p className="text-gray-600 leading-relaxed">
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Deployment Architecture</h3>
                    <p className="text-gray-600 leading-relaxed">
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-3">Monitoring and Analytics</h3>
                    <p className="text-gray-600 leading-relaxed">
