          ...
          >
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-white rounded-3xl p-8">
                <div className="mb-6">
                  <span className="text-base font-semibold text-gray-500">Mobile Application</span>
                  <h1 className="text-2xl font-bold text-gray-900 mt-2">Salon and Spa Appointment Booking App</h1>
                </div>
