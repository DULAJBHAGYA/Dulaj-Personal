...
export default function CoursePerformanceAnalytics() {
  ...
  useEffect(() => {
    if (typeof document !== 'undefined') {
      document.title = 'Multi-Dimensional Course Performance Analytics | Dulaj Personal';
    }
  }, []);
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-white rounded-3xl p-8">
                <div className="mb-6">
                  ...
                  <h1 className="text-3xl font-bold text-gray-900 mt-2">Multi-Dimensional Course Performance Analytics</h1>
                </div>
                
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  A comprehensive analytics dashboard for tracking course performance across multiple dimensions including students, instructors, courses, and campuses.
                </p>
                
                <div className="space-y-6">
                  <p className="text-gray-600 leading-relaxed">
                    This analytics dashboard provides insights into educational performance metrics across various dimensions. It helps educational institutions make data-driven decisions to improve learning outcomes and optimize resource allocation.
                  </p>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span className="text-gray-600">Multi-dimensional data visualization</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">•</span>
                      ...
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">•</span>
                        <span className="text-gray-600">Customizable reporting dashboards</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">•</span>
                        <span className="text-gray-600">Student performance analytics</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">•</span>
                        <span className="text-gray-600">Instructor effectiveness metrics</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">•</span>
                        <span className="text-gray-600">Course comparison tools</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start">
                        <span className="text-blue-500 mr-2 mt-1">•</span>
                        <span className="text-gray-600">Data visualization libraries</span>
                      </li>
                    </ul>
                  </div>
                </div>
