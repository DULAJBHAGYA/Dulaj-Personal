...
export default function ExpenseTracker() {
  const pageTitle = 'Expense Tracker | Dulaj Personal';

  return (
    <main className="min-h-screen bg-white dark:bg-gray-950">
      <Head>
        <title>{pageTitle}</title>
        <meta name="description" content="Modern, responsive expense tracking application with dark mode, customizable dashboard widgets, real-time updates, and mobile-optimized design." />
      </Head>
      <Navbar />
          ...
          >
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-3xl p-8">
                <div className="mb-6">
                  <span className="text-base font-semibold text-gray-500 dark:text-gray-400">Personal Project</span>
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Expense Tracker</h1>
                </div>
