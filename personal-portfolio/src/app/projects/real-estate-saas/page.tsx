          ...
          >
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="bg-white dark:bg-gray-900 rounded-3xl p-8">
                <div className="mb-6">
                  <span className="text-base font-semibold text-gray-500 dark:text-gray-400">SaaS Project</span>
                  <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">Real Estate SaaS Application</h1>
                </div>
