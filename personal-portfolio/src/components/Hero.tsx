        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-900 mb-6">
                I am Dulaj
              </h2>
              
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-black leading-relaxed mb-4">
                IT graduate from{' '}
                <a 
                  href="https://uom.lk" 
                  target="_blank" 
              ...
              <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-500 leading-relaxed">
