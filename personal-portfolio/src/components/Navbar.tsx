  ...
  const getIcon = (iconName: string) => {
    ...
    switch (iconName) {
      ...
      case 'medium':
        return (
          <svg className={iconClass} fill="currentColor" viewBox="0 0 24 24">
            <path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.56 6.42-3.48 6.42-1.93 0-3.49-2.88-3.49-6.42s1.56-6.42 3.49-6.42 3.48 2.88 3.48 6.42zM24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75S24 8.83 24 12z"/>
          </svg>
        );
      case 'instagram':
        return (
